...
class InventoryController extends Controller
{
    ...
    /**
     * MARKER-PATCH-371 — parallel PREVIEW of the item page (image + specs).
     * Read-only; mirrors show()'s data prep exactly so the live page stays
     * untouched. Swap-in = point show() at the -preview view once approved.
     */
