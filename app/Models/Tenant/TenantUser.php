...
class TenantUser extends Authenticatable
{
    ...
    protected $fillable = ['tenant_id','name','email','phone','password','role','role_id','admin_theme','is_active','exempt_from_timeclock','last_login_at','dashboard_view','dashboard_tiles','pin_hash','pin_set_at','pin_failed_count','pin_locked_until','pin_last_used_at'];
    protected $hidden   = ['password','remember_token','pin_hash'];
    protected $casts    = ['is_active' => 'boolean', 'exempt_from_timeclock' => 'boolean', 'last_login_at' => 'datetime', 'dashboard_tiles' => 'array', 'pin_set_at' => 'datetime', 'pin_locked_until' => 'datetime', 'pin_last_used_at' => 'datetime'];
