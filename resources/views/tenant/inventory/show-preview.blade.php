...
@php
  // MARKER-PATCH-374 — Option A (buy-box) layout preview. Mirrors show.blade.php
  // data/bindings exactly; reorganized into media+specs left, sticky summary
  // right, tabbed Activity / Special orders / Sourced from below.
  $pageTitle = $item->name;
