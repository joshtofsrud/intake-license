...
<div class="ia-page-head">
  <div class="ia-page-head-left">
    <h1 class="ia-page-title">{{ $item->name }} <span style="font-size:11px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:var(--ia-accent);border:1px solid var(--ia-accent);border-radius:5px;padding:2px 7px;vertical-align:middle;margin-left:8px">Preview</span></h1>
...
{{-- MARKER-PATCH-371 — product image from distributor catalog --}}
  ...
  <div class="ia-card-body">
    ...
    @else
      <div style="display:flex;align-items:center;gap:14px">
        <div style="width:120px;height:120px;border-radius:8px;background:var(--ia-surface-2,rgba(255,255,255,.04));border:1px dashed var(--ia-border);display:flex;align-items:center;justify-content:center;color:var(--ia-text-muted);font-size:11px;text-align:center">No image<br>yet</div>
        <span style="color:var(--ia-text-muted);font-size:13px">Images aren't synced yet — this lights up once the HLC image fetch is wired (probe &rarr; store).</span>
      </div>
    @endif
  </div>
</div>
...
{{-- MARKER-PATCH-371 — specs from distributor catalog --}}
@php
