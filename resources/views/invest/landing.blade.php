...
.logo{width:26px;height:26px;border-radius:6px;display:block;flex:0 0 26px}
...
<nav><div class="wrap">
  <a class="brand" href="/">
    {{-- MARKER-INVEST-LANDING-ICON — the canonical mark from the logo
         system, not a second copy of it kept in step by hand. --}}
    <img class="logo" src="{{ asset('icon.svg') }}" alt="" width="26" height="26">
    intake</a>
