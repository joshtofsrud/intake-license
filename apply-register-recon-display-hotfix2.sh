#!/bin/bash
# register-recon-display hotfix 2 — admin route group applies a "tenant." name
# prefix; blade route() calls referenced the unprefixed names and 500'd.
set -e
cd "$(git rev-parse --show-toplevel)"
cat > resources/views/tenant/register/index.blade.php <<'RRD_H2A_EOF'
...
RRD_H2A_EOF
cat > resources/views/tenant/register/registers.blade.php <<'RRD_H2B_EOF'
@extends('layouts.tenant.app')
